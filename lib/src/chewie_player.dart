...
class ChewieController extends ChangeNotifier {
  ChewieController({
    ...
    this.autoHideControlsInFullScreen = true,
    this.showSkipButtonsInFullScreen = true,
  ...
  ChewieController copyWith({
    ...
    List<ChapterMarker>? chapterMarkers,
    bool? autoHideControlsInFullScreen,
    bool? showSkipButtonsInFullScreen,
    bool? tapToPlayPause,
    ...
    return ChewieController(
      ...
      chapterMarkers: chapterMarkers ?? this.chapterMarkers,
      autoHideControlsInFullScreen: autoHideControlsInFullScreen ?? this.autoHideControlsInFullScreen,
      showSkipButtonsInFullScreen: showSkipButtonsInFullScreen ?? this.showSkipButtonsInFullScreen,
      tapToPlayPause: tapToPlayPause ?? this.tapToPlayPause,
      showProgressHandle: showProgressHandle ?? this.showProgressHandle,
  ...
  /// Chapter markers to display on the progress bar
  final List<ChapterMarker> chapterMarkers;

  /// Defines if the controls should auto-hide in fullscreen mode
  /// If true (default), controls will auto-hide after the hideControlsTimer duration
  /// If false, controls will remain visible in fullscreen mode
  final bool autoHideControlsInFullScreen;

  /// Defines if skip buttons (10 seconds forward/backward) should be shown in fullscreen
  /// If true (default), skip buttons will be visible in fullscreen mode
  /// If false, skip buttons will be hidden in fullscreen mode
  final bool showSkipButtonsInFullScreen;

  /// Defines if tapping the video screen should play/pause when controls are hidden
  /// If true (default), tapping will toggle play/pause when controls are not visible
  /// If false, tapping will only show controls without affecting playback
  final bool tapToPlayPause;

  /// Defines if the progress handle (circle) should be shown on the progress bar
  /// If true (default), the progress handle circle will be visible
  /// If false, the progress handle will be hidden for a cleaner look
